            ...
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="./powerball.php">Powerball</a>
                        </li>
                        <li>
                            <a href="./mega_millions.php">Mega Millions</a>
                        </li>
                        <li>
                            <a href="./lucky_for_life.php">Lucky for Life</a>
                        </li>
                        <li>
                            <a href="./hot_lotto.php">Hot Lotto</a>
                        </li>
                        <li>
                            <a href="./all_or_nothing.php">All or Nothing</a>
                        </li>
                        <li>
                            <a href="./gopher_5.php">Gopher 5</a>
                        </li>
                        <li>
                            <a href="./northstar_cash.php">Northstar Cash</a>
                        </li>
                        <li>
                            <a href="./daily_3.php">Daily 3</a>
                        </li>
                    </ul>
                </li>
                <li>
